...
def callback(data):
    ...
    v_z = (1 + 10 * data.buttons[5] + 2 * data.buttons[4]) * data.axes[7] / 2
    w_x = (0.2 + 4 * data.buttons[5] + 0.8 * data.buttons[4]) * data.axes[0]
    w_z = (0.2 + 4 * data.buttons[5] + 0.8 * data.buttons[4]) * data.axes[1]
