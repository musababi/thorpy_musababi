...
def callback(data):
    ...
    # Structure of data: [pos0, vel0, pos1, vel1] in mm, mm/s
...
if __name__ == '__main__':
    ...
    global s0, s1, p0, p1, s0_pos, s1_pos
    ...
    initial_offset = [int(10000000.*75/24.44), int(10000000.*75/24.44)]
    ...
    while not rospy.is_shutdown():
        ...
        # s0.print_state()
        in_motion.data = s0.status_in_motion_forward or s0.status_in_motion_reverse or s1.status_in_motion_forward or s1.status_in_motion_reverse
